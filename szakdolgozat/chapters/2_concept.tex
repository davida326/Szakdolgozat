...
Completely Fair Scheduler ütemezési osztály(\texttt{/kernel/sched/fair.c}):
\begin{cpp}
...
A Real-time Scheduler ütemezési osztály (\texttt{/kernel/sched/rt.c}):
\begin{cpp}
...
Deadline Scheduler ütemezési osztály (\texttt{/kernel/sched/deadline.c}):
\begin{cpp}
