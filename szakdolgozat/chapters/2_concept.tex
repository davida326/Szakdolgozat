...
A Generic Scheduler egy absztrakt interface-t definiál a (/kernel/sched/sched.h-ban lévő) sched\_class struktúrán keresztül:
...
\begin{itemize}
	 ...
	 \item Deadline class
\end{itemize}
A következő kódrészletek megmutatják, hogy az osztályok külön-külön hogyan definálják a sched\_class absztrakt struktúrát.
...
A Generic Scheduler réteg egy absztrakt runqueue-t implementál, olyan elemekkel, amik egy runqueue interface-nek felelnek meg.
...
\end{itemize}
% TODO: A futási idő indítása kicsit furcsán hangzik itt.
...
% TODO: Érdekes lehet megindokolni, hogy miért pont ezek az értékek vannak benne.
...
% TODO: A jelöléseket majd át kell gondolni, mert a nyíl operátor furcsa kicsit itt.
