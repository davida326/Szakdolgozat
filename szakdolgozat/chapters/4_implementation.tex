...
Amikor a processzek száma nagyobb mint az \texttt{nr\_latency}, akkor a \texttt{period} megegyezik a \texttt{sched\_min\_granularity\_ns} és a CFS runqueue-ban lévő processzek szorzatával, ami látható az alábbi kódrészletben is.
